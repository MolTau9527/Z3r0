...
from schema.work_project.graph import EDGE_TYPE_CATEGORY
...
def export_frontend_contract_constants(schema: dict[str, Any]) -> Path:
    ...
    edge_categories = list(dict.fromkeys(edge_type_category.values()))
    ...
    FRONTEND_CONTRACT_CONSTANTS_PATH.write_text(
        ...
        f"{enum_constants}\n\n"
        f"export const WORK_PROJECT_GRAPH_EDGE_CATEGORY_VALUES = {json.dumps(edge_categories)} as const;\n"
